...
log = logging.getLogger(Agent.Highly_Volatile_Assets_Picker_Agent)


class HighlyVolatileAssetsPickerAgent:
    history = {}
    max_minutes = 60 * 5
    best_assets = 10
    top_count = {
    ...
    async def accept_message(self, agent, message):
        ...
        if len(detected_assets) > 0:
            ...
            await self.publish(Agent.Pick_Trading_Asset_Agent, top_changes)
